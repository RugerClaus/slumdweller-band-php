<?php 
    ...
    $product = new Product($product_id,$name,'login-system/' . $uploadfile1 , 'login-system/' . $uploadfile2, 'login-system/' . $uploadfile3, 'login-system/' . $uploadfile4, 'login-system/' . $uploadfile5,$type,$instock,$desc,$price);
